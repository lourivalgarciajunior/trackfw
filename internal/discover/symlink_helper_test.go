...
// internal/generators/update_test.go e internal/integrations/manager_test.go.
...
// o que está fora do escopo deste ML ("apenas arquivos de TESTE em internal/").
// Uma cópia por fronteira de pacote é o idioma correto aqui; a lógica é
// idêntica nos três locais — qualquer divergência é um bug.
